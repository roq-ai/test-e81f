              ...
              <Thead>
                <Tr>
                  ...
                  {hasAccess('user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                    <Th>user_performance_evaluation_hr_specialist_idTouser</Th>
                  )}
                  {hasAccess('user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                    <Th>user_performance_evaluation_team_member_idTouser</Th>
                  )}
                  ...
                  <Tr cursor="pointer" onClick={() => handleView(record.id)} key={record.id}>
                    ...
                    {hasAccess('user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                      <Td>
                        <Link
                          as={NextLink}
                          href={`/users/view/${record.user_performance_evaluation_hr_specialist_idTouser?.id}`}
                        >
                          {record.user_performance_evaluation_hr_specialist_idTouser?.email}
                        </Link>
                      </Td>
                    )}
                    {hasAccess('user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                      <Td>
                        <Link
                          as={NextLink}
                          href={`/users/view/${record.user_performance_evaluation_team_member_idTouser?.id}`}
                        >
                          {record.user_performance_evaluation_team_member_idTouser?.email}
                        </Link>
                      </Td>
                    )}
